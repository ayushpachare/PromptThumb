...
export default function Footer() {
    return (
        <footer className="flex flex-wrap justify-center md:justify-between overflow-hidden gap-10 md:gap-20 mt-40 py-6 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500">
            ...
            >
                <Link to='/'>
                    <img className="size-18 w-41 h-9 aspect-square" src="/ayush.png" alt="footer logo" width={142} height={32} />
                </Link>
            ...
            >
                ...
                <p className="mt-3 text-center">&copy; {new Date().getFullYear()} <a href="https://prebuiltui.com?utm_source=pixels">PromptThumb - AI Thumbnail Genrator</a></p>
            </motion.div>
        </footer>
    );
}